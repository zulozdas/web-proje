...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <head>
        ...
        <title>Zülal | Mesajınız Alındı</title>
        <!-- Bootstrap 5 CSS -->
        ...
        <style>
            .success-container {
                ...
                padding: 40px 20px;
                min-height: calc(100vh - 160px); /* Footer ve navbar boşluğu için */
            }
            .success-card {
                background: #f9f7f2;
                max-width: 600px;
    ...
    <body>
        ...
        <nav class="navbar">
            ...
            <span class="nav-logo">ZÜLAL ÖZDAŞ</span>
            <button class="hamburger" id="hamburger" aria-label="Menü">
                <span></span><span></span><span></span>
            </button>
            <ul class="nav-links" id="navLinks">
                <li><a href="../index.html">Ana Sayfa</a></li>
                <li><a href="../hobilerim.html">İlgi Alanlarım</a></li>
                <li><a href="../cv.html">CV</a></li>
                <li><a href="../sehrım.html">Şehrim</a></li>
        ...
        <!-- Footer -->
        <footer class="footer">
            <p>&copy; 2026 Zülal Özdaş. Tüm hakları saklıdır.</p>
        </footer>
